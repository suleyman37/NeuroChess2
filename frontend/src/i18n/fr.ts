export const fr = {
  ...
  decisionCard: {
    ...
    action: "Action",
    unavailableMove: "Coup de la partie non disponible pour cette révision",
  ...
  liveAnalysis: {
    ...
    positionNotAnalyzed: "Position non analysée",
  },
  import: {
  ...
  reviewExplorer: {
    ...
    analyzeLine: "Analyser la ligne",
    analyzingMove: "Évaluation du coup…",
    analyzingLine: "Évaluation de la ligne…",
    analysisPresetLabel: "Précision",
    analysisPresetAria: "Précision de l'analyse Explorer",
    analysisPresets: {
      fast: "Rapide",
      standard: "Standard",
      deep: "Précise",
    },
    lineResult: (count: number, message: string) =>
      `${count} coup${count > 1 ? "s" : ""} analysé${count > 1 ? "s" : ""}. ${message}`,
