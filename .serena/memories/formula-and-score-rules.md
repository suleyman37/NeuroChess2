...
- Visible Review NeuroScore is the coach communication score `coach_neuro_score_v1`, backed by `headline_neurochess_score_v2` aliases after the V1 0.35/0.65 weighting calibration; reference precision remains separate.
