...
function Should-Alert {
    param([string]$Problem)
    return $Problem -notin @("CHATGPT_PAGE_USABLE", "CHATGPT_PROFILE_READY", "GEMINI_PAGE_USABLE", "GEMINI_PROFILE_READY", "GEMINI_WEB_LANE_READY", "GEMINI_WEB_LANE_READY_MODEL_NOT_EXACT", "GEMINI_NOT_CONFIGURED", "GEMINI_NO_VISUAL_EVIDENCE")
}
