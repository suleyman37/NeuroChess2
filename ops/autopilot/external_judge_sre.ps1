...
function Get-ProblemState {
    ...
    switch ($Problem) {
        ...
        "CHATGPT_PROFILE_READY" { "AVAILABLE" }
        "CHATGPT_PROFILE_EXISTS_LOGIN_REQUIRED" { "PARKED_AUTH_REQUIRED" }
        "CHATGPT_WRONG_ACCOUNT_OR_PROJECT_PARKED" { "PARKED_AUTH_REQUIRED" }
        ...
        "GEMINI_PROFILE_READY" { "AVAILABLE" }
        "GEMINI_PROFILE_EXISTS_LOGIN_REQUIRED" { "PARKED_AUTH_REQUIRED" }
        "GEMINI_WRONG_ACCOUNT_OR_PLAN_PARKED" { "PARKED_ACCOUNT_MISMATCH" }
        "GEMINI_WEB_LANE_READY" { "AVAILABLE" }
        "GEMINI_WEB_LANE_READY_MODEL_NOT_EXACT" { "AVAILABLE_MODEL_NOT_EXACT" }
        "GEMINI_AVAILABLE_TEXT_ONLY" { "AVAILABLE_TEXT_ONLY" }
        "GEMINI_VISUAL_PACKET_READY" { "AVAILABLE_VISUAL_PACKET_READY" }
        "GEMINI_AVAILABLE_TEXT_ONLY_UPLOAD_UNAVAILABLE" { "AVAILABLE_TEXT_ONLY_UPLOAD_UNAVAILABLE" }
        "GEMINI_AVAILABLE_TEXT_ONLY_UPLOAD_UNAVAILABLE_DIAGNOSED" { "AVAILABLE_TEXT_ONLY_UPLOAD_UNAVAILABLE" }
        "GEMINI_UPLOAD_UNAVAILABLE_DIAGNOSED" { "AVAILABLE_TEXT_ONLY_UPLOAD_UNAVAILABLE" }
        "GEMINI_AUTH_OR_ACCOUNT_ACTION_REQUIRED_PARKED" { "PARKED_AUTH_REQUIRED" }
        "SHARED_BROWSER_PROFILE_FORBIDDEN" { "PARKED_SAFETY_STOP" }
...
function Get-RetryAfter {
    ...
    $minutes = switch ($Problem) {
        ...
        "GEMINI_PROFILE_EXISTS_LOGIN_REQUIRED" { 60 }
        "GEMINI_WRONG_ACCOUNT_OR_PLAN_PARKED" { 60 }
        "SHARED_BROWSER_PROFILE_FORBIDDEN" { 240 }
        "GEMINI_UPLOAD_UNAVAILABLE" { 60 }
        "GEMINI_UPLOAD_UNAVAILABLE_DIAGNOSED" { 60 }
        "GEMINI_AUTH_OR_ACCOUNT_ACTION_REQUIRED_PARKED" { 60 }
...
function Should-Alert {
    param([string]$Problem)
    return $Problem -notin @("CHATGPT_PAGE_USABLE", "CHATGPT_PROFILE_READY", "GEMINI_PAGE_USABLE", "GEMINI_PROFILE_READY", "GEMINI_WEB_LANE_READY", "GEMINI_WEB_LANE_READY_MODEL_NOT_EXACT", "GEMINI_AVAILABLE_TEXT_ONLY", "GEMINI_VISUAL_PACKET_READY", "GEMINI_NOT_CONFIGURED", "GEMINI_NO_VISUAL_EVIDENCE")
}
...
function Invoke-GeminiLaneAdapterHealth {
    ...
    switch ($status) {
        ...
        "GEMINI_AVAILABLE_TEXT_ONLY" { return Set-LaneAvailable -State $State -LaneName "gemini" -Reason "GEMINI_AVAILABLE_TEXT_ONLY" -Probe $probe }
        "GEMINI_VISUAL_PACKET_READY" { return Set-LaneAvailable -State $State -LaneName "gemini" -Reason "GEMINI_VISUAL_PACKET_READY" -Probe $probe }
        "GEMINI_UPLOAD_UNAVAILABLE_DIAGNOSED" { return Set-LaneAvailable -State $State -LaneName "gemini" -Reason "GEMINI_UPLOAD_UNAVAILABLE_DIAGNOSED" -Probe $probe }
